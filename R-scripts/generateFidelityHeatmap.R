...
for ( deCP in c( "dGRN","dYEL" ) ) {
 ...
 pdf( file=paste("FDHEATMAP/p5/FDheatmap-5p-",deCP,"-",format(Sys.time(), "%Y%m%d"),".pdf",sep=""),width=20,height=18 )
 ...
 dev.off()
 pdf( file=paste("FDHEATMAP/p3/FDheatmap-3p-",deCP,"-",format(Sys.time(), "%Y%m%d"),".pdf",sep=""),width=20,height=18 )
  par( bg="white",mar=c(1,1,1,1) )
 ...
 dev.off()
 pdf( file=paste("FDHEATMAP/all/FDheatmap-5p3p-",deCP,"-",format(Sys.time(), "%Y%m%d"),".pdf",sep=""),width=20,height=35 )
  par( bg="white",mar=c(1,1,1,1) )
