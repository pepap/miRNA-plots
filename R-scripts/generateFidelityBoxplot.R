...
IDR.VB.CON <- c(
   "SOM.r1", "SOM.r2", "SOM",
  "dGRN.r1","dGRN.r2","dGRN",
  "dYEL.r1","dYEL.r2","dYEL"
)
...
#= (1) IDRs : SOM
 ...
 tmp.dt <- data.table( ID=names(tmp.dt),SOM4_r1 =tmp.dt )
