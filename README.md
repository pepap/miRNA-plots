...
The expected input is the result table of the differential expression analysis from [DESeq2](https://www.bioconductor.org/packages//2.13/bioc/html/DESeq2.html) library. The output table is merged with the [miRBase annotation table](miRNA-plots/mirAnnot.pepType.dt.rda).
